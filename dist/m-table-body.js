...
function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableBody, [{
    ...
    value: function render() {
      ...
      }), groups.length > 0 ? this.renderGroupedRows(groups, renderData) : this.renderUngroupedRows(renderData), this.props.showAddRow && React.createElement(this.props.components.EditRow, {
        columns: this.props.columns.filter(function (columnDef) {
          return !columnDef.hidden;
        }),
