      ...
      return React.createElement(_reactBeautifulDnd.DragDropContext, {
        ...
        return React.createElement("div", {
          ...
          onToggleDetailPanel: function onToggleDetailPanel(path, render) {
            var visible = _this5.dataManager.changeDetailPanelVisibility(path, render);

            console.log({
              visible: visible
            });
            _this5.props.detailPanelVisibility && _this5.props.detailPanelVisibility(visible);
...
MaterialTable.propTypes = {
  ...
  detailPanelVisibility: _propTypes["default"].func,
